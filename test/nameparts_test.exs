defmodule NamepartsTest do
  ...
  test "parses multiple aliases" do
      name_parts = Nameparts.parse("\"The People's Champion\" Mohammed \"Louisville Lip\" Ali aka The Greatest")

      # Parse results
      assert name_parts.full_name == "\"The People's Champion\" Mohammed \"Louisville Lip\" Ali aka The Greatest"
